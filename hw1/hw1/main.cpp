...
void sendDataToOpenGL() {
    ...
    //bubble vertices
    const GLfloat bubble_vertices[] = {
        -0.575f, -0.475f, 0.15f,
        -0.575f, -0.475f, 0.1f,
    };
    GLuint bubble_indices[] = {
...
void paintGL(void) {
    ...
    //fish1
    transform = glm::translate(transform, glm::vec3(-0.425f, 0.375f,0.0f));
    ...
    transform = glm::rotate(transform, (GLfloat)glfwGetTime() * (glm::radians(-30.0f)), glm::vec3(0.0f, 0.0f, 1.0f));
    transform = glm::translate(transform, glm::vec3(-0.2f, 0.4f, 0.0f));
    glUniformMatrix4fv(transLoc, 1, GL_FALSE, &transform[0][0]);
    glBindVertexArray(VAO[4]);
    ...
    for (GLuint i = 0; i < 20; i++){
        transform = glm::translate(transform, stonesPositions[i]);
        glUniformMatrix4fv(transLoc, 1, GL_FALSE, &transform[0][0]);
